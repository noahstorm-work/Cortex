  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/4 -left-32 h-96 w-96 rounded-full bg-amber-400/10 blur-[128px] animate-pulse-glow" />
        ...
        <div className="animate-fade-in-up max-w-2xl text-center">
          ...
          <div className="mb-8 inline-flex items-center justify-center">
            <div className="relative">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-xl shadow-amber-500/20">
                <Sparkles className="h-10 w-10 text-white" />
              </div>
              <div className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-background bg-amber-500">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button
              ...
              size="lg"
              className="h-12 min-w-[180px] rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-lg shadow-amber-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/30 hover:scale-[1.02] active:scale-[0.98]"
            >
              {demoLoading ? (
            ...
            <Link href="/login">
              <Button
                variant="outline"
                size="lg"
                className="h-12 min-w-[160px] rounded-xl border-border bg-background/50 backdrop-blur-sm transition-all duration-300 hover:bg-accent/5 hover:border-amber-400/30 hover:shadow-md"
              >
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              ...
              return (
                <div
                  key={i}
                  className="group rounded-xl border border-border/50 bg-background/30 backdrop-blur-sm p-4 text-left transition-all duration-300 hover:border-amber-400/20 hover:bg-amber-400/[0.02] hover:shadow-md"
                  style={{ animationDelay: `${0.2 + i * 0.1}s` }}
                >
                  <div className="mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-amber-400/10 group-hover:bg-amber-400/20 transition-colors duration-200">
