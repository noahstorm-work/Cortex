...
import { Sparkles, Loader2, Eye, EyeOff, Waves } from "lucide-react"
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <Card className="animate-scale-in w-full max-w-sm border-border/50 bg-background/60 backdrop-blur-xl shadow-xl">
        <CardHeader className="text-center pb-6">
          ...
          <CardDescription className="text-sm text-muted-foreground/70">Sign in to your workspace</CardDescription>
        </CardHeader>
        <CardContent>
