...
const mockStats = [
  {
    label: "Documents", value: 42, href: "/documents",
    gradient: "from-teal-400/20", iconBg: "from-teal-400 to-teal-600", accent: "text-teal-400",
  },
  {
    label: "Indexed Chunks", value: 150, href: "/search",
    gradient: "from-violet-400/20", iconBg: "from-violet-400 to-violet-600", accent: "text-violet-400",
  },
  {
    label: "Searches", value: 12, href: "/search",
    gradient: "from-emerald-400/20", iconBg: "from-emerald-400 to-emerald-600", accent: "text-emerald-400",
  },
  {
    label: "Projects", value: "—", href: "/projects",
    gradient: "from-blue-400/20", iconBg: "from-blue-400 to-blue-600", accent: "text-blue-400",
  },
]
